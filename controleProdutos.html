                        ...
                        <div class="container-fluid bg-3 text-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 itemBloqueado">
                                    ...
                                    <button type="button" class="btn btn-default btn-lg removeItem2">
                                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="fa fa-trash"></i> Remover
                                    </button>
                                    <button type="button" class="btn btn-default btn-lg unblockItem">
                                        <span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i class="fa fa-check"></i> Desbloquear
                                    </button>
                                </div>
                            </div>
                        </div>
